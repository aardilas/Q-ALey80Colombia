# Q&A Ley 80 W2V Steam con ChatGPT
...
ruta_source = 'https://raw.githubusercontent.com/aardilas/Q-ALey80Colombia/main/procesado_normas.json'


# LLamado del archivo csv del normograma.
Norma=pd.read_json(ruta_source, encoding='utf-8')
print(Norma.shape)
